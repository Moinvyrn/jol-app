...
class _GroupDetailScreenState extends State<GroupDetailScreen> with WidgetsBindingObserver {
  ...
  void dispose() {
    ...
    _groupSubscription?.cancel(); // Works fine with Group?
    super.dispose();
  }
